package com.atguli.gulimall.gulimallmember.controller;

import java.util.Arrays;
import java.util.Date;
import java.util.Map;

import com.atguli.gulimall.gulimallmember.feign.CouponFeignService;
...
public class MemberController {
    ...
    public R loadmember(){
        ...
        memberEntity.setNickname("小张");
        memberEntity.setBirth(new Date());
        memberEntity.setEmail("2900498871@qq.com");
